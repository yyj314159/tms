    ...
    <el-container>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>油费分摊统计</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="车牌号:">
                            <vehicle-select v-model="searchParam.vehicleCode" style="display:block;"
                                            :clearable="true"></vehicle-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item label="油卡卡号:">
                            <el-input type="text" v-model="searchParam.cardNo" :clearable="true" style="display: block"
                    ...
                    <el-col :span="6">
                        <el-form-item label="分摊月份:">
                            <el-date-picker
                                ...
                                placeholder="请选择月份" :clearable="true" style="width:100%;">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
        ...
        <el-main class="content-main">
            <el-button v-if="exportLoading" v-permission="'/oilFinancialAccounting/export'" icon="el-icon-download"
            ...
            <el-table v-loading="isLoading" size="small" class="content-table" :data="searchResult.result"
                ...
                <el-table-column align="center" prop="licenseNumber" label="车牌号" width="100"></el-table-column>
                <el-table-column align="center" prop="operationMode" label="车辆属性" width="100"></el-table-column>
                <el-table-column align="center" prop="selfOperationMode" label="自营模式" width="100"></el-table-column>
                <el-table-column align="center" prop="settlementMode" label="结算模式" width="100"></el-table-column>
                <el-table-column align="center" prop="rechargeCardNo" label="油卡卡号" width="160"></el-table-column>
                <el-table-column align="center" prop="topCustomer" label="顶级客户" width="120"></el-table-column>
                <el-table-column align="center" prop="rechargeSupplier" label="供应商" width="120"></el-table-column>
                <el-table-column align="center" prop="rechargeType" label="充值类型" width="120"></el-table-column>
                ...
                <el-table-column align="center" prop="count" label="运单数量" width="90"></el-table-column>
                <el-table-column align="center" prop="rechargeRechargeMethod" label="充值方式"
                                 width="100"></el-table-column>
                <el-table-column align="center" prop="month" label="分摊月份" width="90"></el-table-column>
                <el-table-column align="center" prop="kaban" label="是否卡班" width="90"></el-table-column>
        ...
        methods: {
            ...
            searchList() {//查询
                ...
                if (vm.searchParam.settlementModel == 'OUTSOURCE_NOT_TRANSFERRED') {
                    ...
                    vm.searchParam.selfOperationMode = ''
                }
                //长期外请车
                ...
                vm.isLoading = true;
                Http.get(Api.oilFinancialAccounting.page, {params: vm.searchParam}, result => {
            ...
            exportList() {
                ...
                axios.get(Api.oilFinancialAccounting.export, {
