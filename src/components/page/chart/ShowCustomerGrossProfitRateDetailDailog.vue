<template>
    <el-container>
        <el-dialog title="客户毛利率统计明细详情" :visible.sync="Visible" width="90%" :top="marginTop" @close="close">
    ...
    export default {
        ...
        methods: {
            ...
            searchList() {//查询
                let vm = this;
                vm.isLoading = true;
                vm.searchParam.customerCode=vm.currentRowed.code;
                vm.searchParam.actualDepartureStartTime=vm.actualDepartureTimeStart;
                vm.searchParam.actualDepartureEndTime=vm.actualDepartureTimeEnd;
                vm.searchParam.num1=vm.num1;
                vm.searchParam.num2=vm.num2;
                Http.get(Api.departSummary.customerGrossProfitRate,{ params : vm.searchParam }, result => {
