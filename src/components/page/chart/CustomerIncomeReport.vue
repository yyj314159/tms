    ...
    <el-container>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>客户收入成本</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-main class="content-main">
            <el-button v-if="exportLoading" v-permission="'/customerIncome/export'" icon="el-icon-download" type="primary" size="mini" style="margin-left: 10px;" @click="exportList">导出</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            searchList() {//查询
                ...
                vm.isLoading = true;
                Http.get(Api.customerIncome.page,{ params : vm.searchParam }, result => {
            ...
            exportList(){
                ...
                axios.get(Api.customerIncome.export, {params: vm.searchParam, responseType: 'arraybuffer'}).then((response) => {
                    let blob = new Blob([response.data], { type: 'application/x-xls' });
                    let link = document.createElement('a');
                    link.href = window.URL.createObjectURL(blob);
                    //配置下载的文件名
                    link.download = '客户收入成本报表.xls';
                    link.click();
