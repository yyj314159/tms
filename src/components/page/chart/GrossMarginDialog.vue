<template>
    <el-container>
        <el-dialog title="毛利率区间明细详情" :visible.sync="Visible" width="90%" :top="marginTop" @close="close">
    ...
    export default {
        ...
        data() {
            return {
                ...
                searchParam:{//查询参数
                    currentPage: 1,
                    pageSize: 10,
                    grossMarginRate:'',//毛利率区间
                    grossMarginRateOrder:'',//用来表示点击了那个毛利率
        ...
        methods: {
            ...
            searchList() {//查询
                let vm = this;
                vm.isLoading = true;
                vm.searchParam.grossMarginRate=vm.currentRowed.grossMarginRate;
                vm.searchParam.grossMarginRateOrder=vm.currentRowed.grossMarginRateOrder
                ...
                Http.get(Api.departSummary.grossMargin,{ params : vm.searchParam }, result => {
