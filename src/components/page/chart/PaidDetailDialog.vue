<template>
    <el-container>
        <el-dialog title="应付明细详情" :visible.sync="Visible" width="90%" :top="marginTop" @close="close">
    ...
    export default {
        ...
        methods: {
            ...
            searchList() {//查询
                ...
                if(vm.orgCode){
                    vm.searchParam.belongOrgCode=vm.orgCode;//如果大区查询条件不为空，页面点击合计时，将该大区作为条件
                }
                ...
                Http.get(Api.departSummary.paidDetail,{ params : vm.searchParam }, result => {
