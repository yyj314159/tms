<template>
    <el-container>
        <el-dialog title="外请车应付结算进度明细详情" :visible.sync="Visible" width="90%" :top="marginTop" @close="close">
    ...
    export default {
        ...
        methods: {
            ...
            searchList() {//查询
                ...
                Http.get(Api.departSummary.payableSettlement,{ params : vm.searchParam }, result => {
