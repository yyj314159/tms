<template>
    <el-container>
        <el-dialog title="当月补单统计明细详情" :visible.sync="Visible" width="90%" :top="marginTop" @close="close">
    ...
    export default {
        ...
        methods: {
            ...
            searchList() {//查询
                ...
                Http.get(Api.departSummary.monthlySupplementStatistics,{ params : vm.searchParam }, result => {
