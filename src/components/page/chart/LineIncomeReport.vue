    ...
    <el-container>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>线路收入成本</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-main class="content-main">
            <el-button v-if="exportLoading" v-permission="'/lineIncome/export'" icon="el-icon-download" type="primary" size="mini" style="margin-left: 10px;" @click="exportList">导出</el-button>
            ...
            <el-table v-loading="isLoading" size="small" class="content-table" :data="searchResult.result" element-loading-text="拼命加载中" border fit highlight-current-row stripe>
                <el-table-column header-align="center" label="所属大区" prop="regionName" min-width="120" show-overflow-tooltip></el-table-column>
                <el-table-column header-align="center" label="所属分区" prop="orgName" min-width="120" show-overflow-tooltip></el-table-column>
                ...
                <el-table-column header-align="center" label="自营模式" prop="selfOperationMode" min-width="120" show-overflow-tooltip></el-table-column>
                <el-table-column header-align="center" label="车型（米）" prop="specification" min-width="120" show-overflow-tooltip></el-table-column>
                <el-table-column header-align="center" label="发车数" prop="departCount" min-width="120" show-overflow-tooltip></el-table-column>
                <el-table-column header-align="center" label="总里程（公里）" prop="distance" min-width="120" show-overflow-tooltip></el-table-column>
                ...
                <el-table-column header-align="center" label="单公里收入（元）" prop="singleKmReceive" min-width="120" show-overflow-tooltip></el-table-column>
                <el-table-column header-align="center" label="单公里成本（元）" prop="singleKmPaid" min-width="120" show-overflow-tooltip></el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            searchList() {//查询
                ...
                vm.isLoading = true;
                Http.get(Api.lineIncome.page,{ params : vm.searchParam }, result => {
            ...
            exportList(){
                ...
                axios.get(Api.lineIncome.export, {params: vm.searchParam, responseType: 'arraybuffer'}).then((response) => {
                    let blob = new Blob([response.data], { type: 'application/x-xls' });
                    let link = document.createElement('a');
                    link.href = window.URL.createObjectURL(blob);
                    //配置下载的文件名
                    link.download = '线路收入成本报表.xls';
                    link.click();
