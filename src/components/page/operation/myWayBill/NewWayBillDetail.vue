        ...
        <el-form id="waybill" size="small" label-position="left">
                    ...
                    <el-row v-if="searchResult.dispatch.dispatchVehicle.vehicleNature!==Constant.VEHICLE_OPERATION_MODE.SELF_SUPPORT">
                        ...
                        <el-col :span="5">
                            <el-form-item label="承运方:">
                                {{searchResult.dispatch.dispatchVehicle.shipper ? searchResult.dispatch.dispatchVehicle.shipper.name : "无"}}
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                        ...
                        <el-col :span="4">
                            <el-form-item label="是否开票:">
                                {{searchResult.dispatch.dispatchVehicle.ticket ? "是" : "否"}}
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row v-else>
            ...
            <el-row class="card" v-if="$_permission('/waybillDetail/receiveConfirm') && hasDataPermission">
                <el-row>
                    ...
                    （<dictionary-select-name option-name="LINE_PRICE_TYPE" v-model="searchResult.dispatch.dispatchPrice.receivePriceType"></dictionary-select-name>）</span>
            ...
            <el-row class="card" v-if="$_permission('/waybillDetail/paidConfirm')">
                ...
                （<dictionary-select-name option-name="LINE_PRICE_TYPE" v-model="searchResult.dispatch.dispatchPrice.paidPriceType"></dictionary-select-name>）</span>
                    ...
                    <el-row>
                        <el-col :span="4">
                            <el-form-item label="预付打卡:">
                                ...
                                <b v-show="searchResult.dispatch.dispatchPrice.prepaidCardAmount>0">
                        ...
                        <el-col :span="5">
                            <el-form-item label="回单押金:">
                                ...
                                <b v-show="searchResult.dispatch.dispatchPrice.returnDeposit > 0">
                                    <span v-if="(searchResult.supplierPayableBill && searchResult.supplierPayableBill.returnDeposit===Constant.PAYMENT_TYPE.PAYMENT)||(searchResult.payableBill && searchResult.payableBill[0].paymentState === Constant.PAY_STATUS.PAID)" style="color:green;">(已退)</span>
                    ...
                    <el-row>
                        <el-col :span="4">
                            <el-form-item label="回单付款:">
                                ...
                                <b v-show="searchResult.dispatch.dispatchPrice.returnAmount">
    ...
    export default {
        ...
        methods: {
            isReturnAmountPaid(){//回单付款是否已付
                return (this.searchResult.supplierPayableBill && this.searchResult.supplierPayableBill.remainAmountRefunds) || (this.searchResult.payableBill && this.searchResult.payableBill[0].paymentState === Constant.PAY_STATUS.PAID);
            },
            //获取运单详情
