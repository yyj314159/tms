<template>
    <el-dialog title="受理车辆异常" :visible.sync="visible" width="70%" @close="close">
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button :disabled="btnLoading" size="small" type="primary" @click="submit('success')">受理成功</el-button>
            <el-button :disabled="btnLoading" size="small" type="danger" @click="submit('fail')">受理失败</el-button>
        </span>
    </el-dialog>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit(type){
                let url = type === 'success'?Api.vehicleException.success:Api.vehicleException.fail;
                let message = type === 'success'?'已受理成功！':'已受理失败！';
                this.btnLoading = true;
                Http.post(url, {waybillCode: this.form.waybill.code}, result => {
