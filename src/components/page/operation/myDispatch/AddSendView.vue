            ...
            <el-row v-else>
                ...
                <el-col :span="4">
                    <el-form-item label="承运方:">
                        {{addVehicleForm.dispatchVehicle.shipper ? addVehicleForm.dispatchVehicle.shipper.name : "无"}}
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="是否开票:">
                        {{addVehicleForm.dispatchVehicle.ticket ? "是" : "否"}}
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="回货:" label-width="75px">
            ...
            <el-row>
                ...
                <el-col :span="5">
                    <el-form-item label="油卡金额:">
                        {{addVehicleForm.dispatchPrice.oilCardAmount}} 元
                    </el-form-item>
                </el-col>
                <el-col :span="5">
                    <el-form-item label="油卡卡号:">
                        {{addVehicleForm.dispatchPrice.oilCardNumber}}
                    </el-form-item>
                </el-col>
                <el-col :span="5">
                    <el-form-item label="油卡余额:">
                        {{addVehicleForm.dispatchPrice.oilCardBalance}} 元
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item label="油卡押金:">
                        {{addVehicleForm.dispatchPrice.oilCardDeposit}} 元
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="5">
                    <el-form-item label="定点加油:">
                        {{addVehicleForm.dispatchPrice.refuelingAmount}} 元
                        <span v-show="addVehicleForm.dispatchPrice.refuelingAmount>0">(<dictionary-select-name option-name="REFUELING_TYPE" :value="addVehicleForm.dispatchPrice.refuelingType"></dictionary-select-name>)</span>
                    </el-form-item>
                </el-col>
                <el-col :span="5">
                ...
                <el-col :span="5">
                    <el-form-item label="GPS押金:">
                        {{addVehicleForm.dispatchPrice.gpsDeposit}} 元
                    </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <el-row>
                <el-col :span="5">
                    <el-form-item label="货到打卡:">
                        {{addVehicleForm.dispatchPrice.deliveryAmount}} 元
                    </el-form-item>
                </el-col>
                <el-col :span="5">
