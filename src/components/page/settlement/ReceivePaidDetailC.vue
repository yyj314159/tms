<template>
    <el-container>
        ...
        <el-main class="content-main">
            <el-button v-if="exportLoading" v-permission="'/receivePaidDetailCopy/export'" icon="el-icon-download"
            ...
            <el-table v-loading="isLoading" size="small" class="content-table" :data="searchResult.result"
                ...
                <el-table-column align="center" label="应收运费(应收)" prop="receiveAmount" minAPPLY_TYPE-width="120" show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            searchList() {//查询
                let vm = this;
                vm.isLoading = true;
                Http.get(Api.receivePaidDetailCopy.page, {params: vm.searchParam}, result => {
            ...
            exportList() {
                ...
                axios.get(Api.receivePaidDetailCopy.export, {
